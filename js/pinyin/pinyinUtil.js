importScripts('pinyin/pinyin_dict_notone.js');
importScripts('pinyin/pinyin_dict_polyphone.js');
importScripts('pinyin/pinyin_dict_withtone.js');
importScripts('pinyin/pinyin_dict_firstletter.js');
